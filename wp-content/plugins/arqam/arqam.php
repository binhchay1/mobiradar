<?php
/*
	Plugin Name: Arqam - Social Counter Plugin
...
define ( 'ARQAM_Plugin_ver', '2.7.1' );
define ( 'ARQAM_PLUGIN_ID', '5085289' );

$arq_data      = array();
$arq_options	 = get_option( 'arq_options' ) ? get_option( 'arq_options' ) : array( 'data' => array() );
...
$arq_social_items = array( 'facebook', 'twitter', 'youtube', 'vimeo', 'dribbble', 'github', 'soundcloud', 'behance', 'instagram', 'mailchimp', 'mailpoet', 'mymail', 'foursquare', 'linkedin', 'vk', 'tumblr', '500px', 'pinterest', 'flickr', 'steam', 'twitch', 'mixcloud', 'goodreads', 'rss', 'posts', 'comments', 'groups', 'forums', 'members', 'topics', 'replies');
